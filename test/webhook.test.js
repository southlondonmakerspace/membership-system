...
const paymentWithSubscription = require('./fixtures/paymentWithSubscription.json');
const paymentWithoutSubscription = require('./fixtures/paymentWithoutSubscription.json');
const subscriptionOneYear = require('./fixtures/subscriptionOneYear.json');
const subscriptionOneMonth = require('./fixtures/subscriptionOneMonth.json');
const subscriptionTwelveMonths = require('./fixtures/subscriptionTwelveMonths.json');
